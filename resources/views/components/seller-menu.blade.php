...
<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-member" role="button" aria-expanded="false"
    ...
    <ul class="sub-nav collapse" id="sidebar-member" data-bs-parent="#sidebar-menu">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-member-1" role="button"
                aria-expanded="false" aria-controls="sidebar-member-1">
                <i class="icon">
                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
