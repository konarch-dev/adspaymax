               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="new-user-info">
                        <form action="{{ route('seller.coupon.editpassword') }}"  method="POST" enctype="multipart/form-data">
                            ...
                            @csrf
                             <div class="row">
                              ...
                              <div class="form-group col-md-6">
                               ...
                               <div class="form-group col-md-6">
                                 <label class="form-label" for="zip">New Password:</label>
                                 <input type="text" class="form-control" id="zip" name="password"   placeholder="Enter new password">
                              </div>
