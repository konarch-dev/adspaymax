                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="new-user-info">
                                <form action="{{ route('seller.coupon.editprofile') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <img style="height:100px;width:100px"
                                                src="{{ url('/public/' . $userdata[0]['logo']) }}">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $userdata[0]['name'] }}" name="fname" id="fname"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $userdata[0]['address'] }}" id="address" name="address"
                                                placeholder="Address">
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="store"
                                                value="{{ $userdata[0]['store'] }}" name="store"
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            <select id="state-dropdown" name="state" class="selectpicker form-control"
                                                data-style="py-0">
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            <select id="city-dropdown" name="city" class="selectpicker form-control"
                                                data-style="py-0">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="zip" name="zip"
                                                value="{{ $userdata[0]['zip'] }}" placeholder="zip code">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="email">Email:</label>
                                            <input type="email" class="form-control"
                                                value="{{ $userdata[0]['email'] }}" id="email" name="email"
