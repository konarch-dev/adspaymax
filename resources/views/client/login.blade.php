                                    ...
                                    <div class="box-detail res-width">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <h4 class="hover marB10"><a href="blog-details.html">Sign In</a></h4>

                                                <span><input type="email" name="email" class="form-control" placeholder="Enter Email Address"></span>
                                                <p>&nbsp;</p>
                                                <span><input type="password" name="password" class="form-control" placeholder="Enter Password"></span>
                                                <p>&nbsp;</p>
                                                <span><input type="submit" class="btn btn-primary" value="Login">&nbsp;&nbsp;&nbsp;<a href="signup">New User? Sign Up Now</a></span>
