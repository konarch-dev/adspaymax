                  ...
                  <div class="col-md-10">
                     <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                        <div class="card-body">
                           ...
                           <p class="text-center">Sign Up As a Admin.</p>
                           <form>
                              <div class="row">
                                 <div class="col-lg-12">
                                 ...
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <input type="email" class="form-control" value="{{ old('email') }}" name="email" placeholder=" ">
                                    </div>
                                 </div>
                              ...
                              <p class="mt-3 text-center">
                                Already have an Account <a href="{{ url('/admin/login')}}" class="text-underline">Sign In</a>
                             </p>
