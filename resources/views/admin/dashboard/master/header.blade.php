      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
              ...
              <li class="nav-item dropdown">
                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <img src="{{ asset('admin/assets/images/avatars/01.png')}}" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                  <img src="{{ asset('admin/assets/images/avatars/avtar_1.png')}}" alt="User-Profile" class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded">
                  <img src="{{ asset('admin/assets/images/avatars/avtar_2.png')}}" alt="User-Profile" class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded">
                  <img src="{{ asset('admin/assets/images/avatars/avtar_4.png')}}" alt="User-Profile" class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded">
                  <img src="{{ asset('admin/assets/images/avatars/avtar_5.png')}}" alt="User-Profile" class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded">
                  <img src="{{ asset('admin/assets/images/avatars/avtar_3.png')}}" alt="User-Profile" class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded">
                  <div class="caption ms-3 d-none d-md-block ">
                      <h6 class="mb-0 caption-title">{{ Session::get('ausername')}}</h6>
                      <p class="mb-0 caption-sub-title">{{ Session::get('atype')}}</p>
                  </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                   <li><a class="dropdown-item" href="/apmax1/admin/profile/">Profile</a></li>
                      <li><a class="dropdown-item" href="/apmax1/admin/password/">Change Password</a></li>
        ...
        <div class="iq-navbar-header" style="height: 215px;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            <div>
                                <h1>Hello {{session::get('ausername')}}!</h1>
                           </div>
            ...
            <div class="iq-header-img">
                <img src="{{ asset('admin/assets/images/dashboard/top-header.png')}}" alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX">
                <img src="{{ asset('admin/assets/images/dashboard/top-header1.png')}}" alt="header" class="theme-color-purple-img img-fluid w-100 h-100 animated-scaleX">
                <img src="{{ asset('admin/assets/images/dashboard/top-header2.png')}}" alt="header" class="theme-color-blue-img img-fluid w-100 h-100 animated-scaleX">
                <img src="{{ asset('admin/assets/images/dashboard/top-header3.png')}}" alt="header" class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX">
                <img src="{{ asset('admin/assets/images/dashboard/top-header4.png')}}" alt="header" class="theme-color-yellow-img img-fluid w-100 h-100 animated-scaleX">
                <img src="{{ asset('admin/assets/images/dashboard/top-header5.png')}}" alt="header" class="theme-color-pink-img img-fluid w-100 h-100 animated-scaleX">
            </div>
          ...
          <ul  class="p-0 m-0 mb-2 swiper-wrapper list-inline">
                ...
                <div class="card-body">
                   <div class="progress-widget">
                    ...
                    <div class="progress-detail">
                         <p  class="mb-2">Coupon Listed</p>
                         <h4 class="counter">{{$product}}</h4>
                      </div>
                   </div>
                </div>
             </li>
             <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="800">
                <div class="card-body">
                   ...
                   <div class="progress-detail">
                         <p  class="mb-2">Active Coupon Listed</p>
                ...
                <div class="card-body">
                   <div class="progress-widget">
                      <div id="circle-progress-03" class="text-center circle-progress-01 circle-progress circle-progress-primary" data-min-value="0" data-max-value="100" data-value="70" data-type="percent">
                       ...
                       <div class="progress-detail">
                        <p  class="mb-2">Inactive Coupon Listed</p>
                         <h4 class="counter">{{$inactive}}</h4>
                      </div>
                   </div>
                </div>
             </li>
                   ...
                   <table id="basic-table" class="table mb-0 table-striped" role="grid">
                      ...
                      <tbody>
                         <tr>
                            <td>
                               <div class="d-flex align-items-center">
                                  <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="{{ URL::asset('admin/assets/images/shapes/01.png')}}" alt="profile">
                         ...
                         <tr>
                            <td>
                               <div class="d-flex align-items-center">
                                  <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="{{ URL::asset('admin/assets/images/shapes/05.png')}}" alt="profile">
                         ...
                         <tr>
                            <td>
                               <div class="d-flex align-items-center">
                                  <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="{{ URL::asset('admin/assets/images/shapes/02.png')}}" alt="profile">
                         ...
                         <tr>
                            <td>
                               <div class="d-flex align-items-center">
                                  <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="{{ URL::asset('admin/assets/images/shapes/03.png')}}" alt="profile">
                         ...
                         <tr>
                            <td>
                               <div class="d-flex align-items-center">
                                  <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="{{ URL::asset('admin/assets/images/shapes/04.png')}}" alt="profile">
