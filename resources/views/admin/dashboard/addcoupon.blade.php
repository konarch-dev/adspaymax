            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    @endif
                        ...
                        <form action="{{ route('admin.coupon.image') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                   ...
                                   <textarea class="form-control"  name="detail"  id="validationDefault02" placeholder="Required example textarea" required=""></textarea>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group input-group">
                                        ...
                                        <input type="number" name="price"  class="form-control" id="validationCustomUsername"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-text" id="basic-addon1">$</span>
                                        <input type="number" name="saleprice"  class="form-control" id="validationCustomUsername1"
                                            aria-label="Sale Price" aria-describedby="basic-addon1" >
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="validationDefault033">Add Discount</label>
                                    <input type="number" name="discount" class="form-control" id="validationDefault033" >
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="validationDefault0333">Code</label>
                                    <input type="text" name="code" class="form-control" id="validationDefault0333" required>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="valid" class="form-control" id="validationDefault0333" required>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="validationDefault033355">Zip Code</label>
                                    <input type="text" name="zip" class="form-control" id="validationDefault033355" required>
                                </div>

                                
                                <div class="col-md-6 mb-3">
                                    <input class="form-check-input" value="1" type="radio" name="listing" id="flexRadioDefault1" checked>
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Enable Listing
                                    </label>
                                    <input class="form-check-input" value="0" type="radio" name="listing" id="flexRadioDefault1">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Disable Listing
                                    </label>
                                </div>
